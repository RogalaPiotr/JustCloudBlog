...
Jeśli korzystacie z Azure i zastanawialiście się, jak w prosty sposób zarządzać storage'ami, polecam Azure Storage Explorer wydany przez Microsoft. Narzędzie możemy pobrać tutaj: [https://azure.microsoft.com/pl-pl/products/storage/storage-explorer](https://azure.microsoft.com/pl-pl/products/storage/storage-explorer). Jak połączyć je z Azure? Logujemy się do portalu, klikamy na kontener z zawartością dysków. Na dole strony pojawi się ikona "Keys" dotycząca Manage Access Keys. Są to wygenerowane dane, które umożliwiają tworzenie federacji pomiędzy portalami lub programami, takimi jak ASE.
